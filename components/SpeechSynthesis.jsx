...
function TemplateOne({ text }) {
    ...
    return (
        speech.hasBrowserSupport() ?
            <div className='flex justify-center items-center w-full z-30 bg-[#00404a] px-[100px] py-2 rounded-[10px] ' style={{background: 'linear-gradient(to right, #00404a, #007483, #00404a)'}}>
