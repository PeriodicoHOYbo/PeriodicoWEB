...
function MyBook(props) {
    ...
    return (
        userDB && userDB !== undefined && userDB.EdicionDigital && userDB.EdicionDigital[ router.query.edicion] && userDB.EdicionDigital[ router.query.edicion] !== undefined && <div className='relative top-[-200px] bg-[#00404a] h-screen w-full flex items-center overflow-hidden sm:h-auto lg:max-h-[300vh] sm:min-h-screen'>
