...
function MyBook(props) {
    ...
    return (
        userDB && userDB !== undefined && userDB.EdicionDigital && userDB.EdicionDigital[ router.query.edicion] && userDB.EdicionDigital[ router.query.edicion] !== undefined && <div className=' bg-[#00404a] h-screen w-full flex items-center overflow-hidden sm:h-auto sm:min-h-screen sm:pt-[75px]'>
            ...
            <HTMLFlipBook width={window.screen.width - 200} height={window.screen.width * 1.3}
